...
public class OceanKnuckle extends SpellWeaponItem implements ConfigurableAttributes {
    ...
    public OceanKnuckle(ToolMaterial material, Settings settings) {
        this(material, 1, 2.4F, settings);
    }

    public OceanKnuckle(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
