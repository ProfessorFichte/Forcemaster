...
public class PhaslebArmor extends ModArmorItem implements GeoItem {
    ...
    public void setAttributes(Multimap<EntityAttribute, EntityAttributeModifier> attributes) {
        ...
        builder.put(MRPGCEntityAttributes.ARCANE_FUSE_MODIFIER,new EntityAttributeModifier(uuid,"arcane_fuse",0.05, EntityAttributeModifier.Operation.MULTIPLY_BASE));
